...
template<typename ForwardIterator, typedef T, typedef IsPOD>
...
template<typename ForwardIterator, typedef T>
void __uninitialized_fill(ForwardIterator first,
                          ForwardIterator last,
                          const T &x,
                          tt::__true_type) {
...
void uninitialized_fill(ForwardIterator first,
  ...
  typedef typename tt::iterator_traits<first>::value_type Type;
  typedef typename tt::__type_traits<Type>::is_POD_type IsPOD;
  tt::__uninitialized_fill(first, last,
  const T &x, IsPOD());
}

template<typename InputIterator, typename ForwardIterator, typename Size, typename T, typename IsPOD>
ForwardIterator __uninitialized_copy_n(InputIterator first,
                                       Size count,
                                       ForwardIterator result,
                                       IsPOD) {
  ForwardIterator cur = result;
...
template<typename InputIterator, typename ForwardIterator, typename Size, typename T>
ForwardIterator __uninitialized_copy_n(InputIterator first,
                                       Size count,
                                       ForwardIterator result,
                                       tt::__true_type) {
...
ForwardIterator __uninitialized_fill_n(ForwardIterator first, Size count, const T &x, IsPOD) {
  while (count-- != 0) {
    tt::construct(&*first, x);
    first++;
  }
...
ForwardIterator __uninitialized_fill_n(ForwardIterator first, Size count, const T &x, tt::__true_type) {
